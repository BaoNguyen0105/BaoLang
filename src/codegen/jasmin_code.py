...
class MachineCode(ABC):
    ...
    @abstractmethod
    def emitINVOKEINTERFACE(self, lexeme, typ, n):
        pass
...
class JasminCode(MachineCode):
    ...
    # n: Int (number of arguments)
        return JasminCode.INDENT + "invokeinterface " + lexeme + typ + " " + str(n) + JasminCode.END
    
    def emitCHECKCAST(self, typ):
        return JasminCode.INDENT + "checkcast " + typ + JasminCode.END
